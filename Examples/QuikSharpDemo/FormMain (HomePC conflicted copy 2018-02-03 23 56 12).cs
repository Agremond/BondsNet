   ...
   //         Graphics graf = picGraph.CreateGraphics();
        ...
        void Positions2Table()
        {
            ...
            for (int i = 0;i < positions.Count;i++)
            {
                ...
                {
                    dataGridViewPositions.Rows.Add();
                    int j = dataGridViewPositions.Rows.Count - 1;
                    ...
                    int LastRow = dataGridViewPositions.RowCount - 1;
                    dataGridViewPositions.FirstDisplayedScrollingRowIndex = LastRow;
                }
                else
                {
                    dataGridViewPositions.Rows[i].
                }
