...
public class Tool   
{
    ...
    /// Длительность купона
    /// </summary>
    public decimal couponPeriod { get { return couponPeriod; } }
    /// <summary>
    /// Номинал купона
    /// </summary>
    ...
    /// </summary>
    /// 
    public decimal LastPrice { get { return LastPrice; } }
            ...
            if (quik != null)
            {
                if (classCode != null && classCode != "")
                {
                    try
                    {
                        ...
                        couponPeiod = Convert.ToDecimal(_quik.Trading.GetParamEx(classCode, securityCode, "COUPONPERIOD").Result.ParamValue.Replace('.', separator));
