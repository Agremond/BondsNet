    ...
    public partial class FormMain : Form
    {
       ...
       // FuturesClientHolding futuresPosition;
        ...
        void Run()
        {
            ...
            {
                if (toolsOrderBook[secCodeindex].offer != null)
                {
                    textBoxBestOffer.Text = Convert.ToString(toolsOrderBook[secCodeindex].offer[0].price);
                }
        ...
        void GetIndicators()
        {
            ...
            if(tools != null)
                for ( int i = 0; i <= tools.Capacity;i++)
                {
                    ...
                    if (toolsOrderBook != null)
                    {
                        for (int j = 0; j <= toolsOrderBook.Capacity; j++)
                        {
